...
class LuxsAPI:
    ...
    def get_objects(self, 
                   ...
                   page: int = 0,
                   page_size: int = 100) -> Optional[List[Dict]]:
    ...
    def get_objects_by_type(self,
                          ...
                          attributes_filter: Optional[Dict[str, str]] = None,
                          only_active: bool = False,
                          page: int = 0,
                          page_size: int = 100) -> Optional[List[Dict]]:
    ...
    def _make_request(self, 
                     ...
                     data: Optional[Any] = None) -> Optional[Union[List, Dict]]:
        """Make API request and handle response"""
        try:
            response = self.client.make_request(endpoint, method=method, params=params, data=data)
